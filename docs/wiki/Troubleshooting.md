...
The readiness badge in the top-right corner tells you if Elisa is ready to build:
...
- **Dev mode**: Make sure the backend is running. It should be on port 8000.
...
- Build errors include details about what went wrong.
...
- See [Hardware Integration](Hardware-Integration) for the full list of supported boards.
